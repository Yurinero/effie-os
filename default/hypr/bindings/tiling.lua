...
o.bind("ALT + SPACE", "Workspace overview and switcher", "omarchy-shell shell toggle omarchy.workspace-switcher")
o.bind("SUPER + TAB", "Workspace overview and switcher", "omarchy-shell shell toggle omarchy.workspace-switcher")
...
o.bind("ALT + TAB", "Workspace overview and switcher", "omarchy-shell shell toggle omarchy.workspace-switcher")
o.bind("ALT + SHIFT + TAB", "Workspace overview and switcher", "omarchy-shell shell toggle omarchy.workspace-switcher")
